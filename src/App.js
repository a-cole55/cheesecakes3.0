...
function App() {
 ...
 <div 
            ...
            transition={transition}> */}
                <img class="homeLogo" src={HomeLogo} alt="logo"></img>
        <p
            // initial={{ y: "-70%"}}
            // animate={{ y: "-45%", transition: {delay: 0.4, duration: 1, ease: [0.43, 0.13, 0.23, 0.96]}}}
            // exit={{ opacity: 0}}
            // transition={transition}
            >Welcome Cheesecake Lover! I look forward to providing you with the best quality cheesecakes you've ever experienced.</p>
        <img class="landing-image right" src={Home2} alt="cheesecake img"></img>
        <img class="landing-image left" src={HomeImg} alt="cheesecake img"></img>
        ...
        <div className="specialsPreviewContainer">
            ...
            <img whileHover={{scale:1.1}} src={special} alt="turtle cheesecake cupcakes" />
